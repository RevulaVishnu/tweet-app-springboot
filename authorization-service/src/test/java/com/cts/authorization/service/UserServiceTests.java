...
//
//		// Data to mock
//		UserData user = new UserData("admin1", "$2a$10$aMMcsBB18R7dqzC7Wcg3z.oiVQnNhgFGD0WMTZVeVtFCMMnru25AO", "ADMIN");
//
//		// Convert to optional
//		Optional<UserData> userOptional = Optional.of(user);
//
...
//
//		// Data to mock
//		Optional<UserData> userOptional = Optional.empty();
//
